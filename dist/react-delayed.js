...
var ReactDelayed = function (_Component) {
  ...
  function ReactDelayed() {
    var _ref;

    var _temp, _this, _ret;

    _classCallCheck(this, ReactDelayed);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ReactDelayed.__proto__ || Object.getPrototypeOf(ReactDelayed)).call.apply(_ref, [this].concat(args))), _this), _this.state = { mounted: typeof window === 'undefined' ? _this.props.mounted : false, deferred: null }, _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(ReactDelayed, [{
    ...
    value: function handleVisibility(type) {
      ...
      var deferred = invoker(function () {
        return _this2.isComponentMounted && _this2.setState({ mounted: mounted });
      }, timeout);
